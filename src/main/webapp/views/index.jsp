...
<head>
  ...
  <title>Jawaid Sampling</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<spring:url value="/img/favicon.png"/>" rel="icon">
  <link href="<spring:url value="/img/apple-touch-icon.png"/>" rel="apple-touch-icon">
  ...
  <link href="<spring:url value="/vendor/icofont/icofont.min.css"/>" rel="stylesheet">
  <link href="<spring:url value="/vendor/font-awesome/css/font-awesome.min.css"/>" rel="stylesheet">
  <link href="<spring:url value="/vendor/ionicons/css/ionicons.min.css"/>" rel="stylesheet">
  <link href="<spring:url value="/vendor/animate.css/animate.min.css"/>" rel="stylesheet">
  <link href="<spring:url value="/vendor/venobox/venobox.css"/>" rel="stylesheet">
  <link href="<spring:url value="/vendor/owl.carousel/assets/owl.carousel.min.css"/>" rel="stylesheet">
  <link href="<spring:url value="/vendor/aos/aos.css"/>" rel="stylesheet">
...
<spring:url value="/index" var="indexUrl" />
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 d-flex align-items-center">
          <h1 class="logo mr-auto"><a href="${indexUrl}">SamplinG</a></h1>
          <!-- Uncomment below if you prefer to use an image logo -->
          <!-- <a href="index.html" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

          <nav class="nav-menu d-none d-lg-block">
            <ul>
              <li class="active"><a href="${indexUrl}">Home</a></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="about-col">
              <div class="img">
                <img src="<spring:url value="/img/about-mission.jpg"/>" alt="" class="img-fluid">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="about-col">
              <div class="img">
                <img src="<spring:url value="/img/about-plan.jpg"/>" alt="" class="img-fluid">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="about-col">
              <div class="img">
                <img src="<spring:url value="/img/about-vision.jpg"/>" alt="" class="img-fluid">
  ...
  <script src="<spring:url value="/vendor/php-email-form/validate.js"/>"></script>
  <script src="<spring:url value="/vendor/waypoints/jquery.waypoints.min.js"/>"></script>
  <script src="<spring:url value="/vendor/counterup/counterup.min.js"/>"></script>
  <script src="<spring:url value="/vendor/isotope-layout/isotope.pkgd.min.js"/>"></script>
  <script src="<spring:url value="/vendor/venobox/venobox.min.js"/>"></script>
  <script src="<spring:url value="/vendor/owl.carousel/owl.carousel.min.js"/>"></script>
  <script src="<spring:url value="/vendor/aos/aos.js"/>"></script>
